...
export function Controls({
    ...
    return (
        <div className="flex flex-wrap items-center gap-3 p-3 border rounded-md bg-card/60">
            ...
            <div className="flex items-center gap-2 w-full sm:w-auto" title="Change animation speed">
            ...
            <div className="flex items-center gap-2 w-full sm:w-auto">
                <Button onClick={onGoToEndingState} variant="outline">
                    Go to Ending State
                </Button>
            </div>
        </div>
